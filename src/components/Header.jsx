      ...
      <header className="w-[90%] h-full flex justify-between items-center">
        ...
        <nav className="hidden sm:flex items-center gap-6 text-white font-medium">
          {isAuthenticated?(<>
             <Link
                to="/cart"
                className="bg-yellow-500 px-4 py-2 rounded-lg text-white hover:bg-yellow-600 transition-colors duration-200"
              >
              ...
              >
              <button type="button" onClick={handleLogOutBtn} className="hover:cursor-pointer">  
                Log Out
                </button>
              </Link>
          </> ):(
